...
class StringCmdRequest {
  ...
  static datatype() {
    ...
    return 'robo_cylinder/StringCmdRequest';
  }
...
class StringCmdResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robo_cylinder/StringCmdResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '4d6784651d35dac8aad2a3eb7cbc01aa'; },
  datatype() { return 'robo_cylinder/StringCmd'; }
};
