...
def publish_transforms(broadcast,q0_,q_inverse,location):
    ...
    # camera_transform.transform.rotation.x = pose_sub.orientation.x
    # camera_transform.transform.rotation.y = pose_sub.orientation.y
    # camera_transform.transform.rotation.z = pose_sub.orientation.z
    # camera_transform.transform.rotation.w = pose_sub.orientation.w
    ...
    camera_transform.transform.translation.x = location[0]
    camera_transform.transform.translation.y = location[1]
    camera_transform.transform.translation.z = location[2]
    

    camera_transform.transform.rotation.x = q_inverse[0]
    camera_transform.transform.rotation.y = q_inverse[1]
    camera_transform.transform.rotation.z = q_inverse[2]
    camera_transform.transform.rotation.w = q0_
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # publish transform
        #publish_transforms(broadcast,q0_,q_inverse,-np.dot(rvec_matrix.T, translation_vector))
        rate.sleep()
...
if __name__ == '__main__':
    ...
    main()
# import tf
# R = tf.transformations.rotation_matrix(theta_,unit_vector_)
# # print(rvec_matrix.shape)
# # print(type(rvec_matrix))
# q = tf.transformations.quaternion_from_matrix(R.T)
# # print(R.T)
# # print(rvec_matrix.T)
# print('new approach: ',q)