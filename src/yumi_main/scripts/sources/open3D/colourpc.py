...
if __name__ == "__main__":
    ...
    source = read_point_cloud("basic/TestData/ColoredICP/frag_115.ply")
    target = read_point_cloud("basic/TestData/ColoredICP/frag_116.ply")
    #
    ...
    for scale in range(3):
        ...
        result_icp = registration_colored_icp(source_down, target_down,radius, current_transformation,ICPConvergenceCriteria(relative_fitness = 1e-6,relative_rmse = 1e-6, max_iteration = iter))
