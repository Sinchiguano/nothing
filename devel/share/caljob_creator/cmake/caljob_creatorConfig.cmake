...
if(caljob_creator_CONFIG_INCLUDED)
  return()
endif()
set(caljob_creator_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(caljob_creator_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/industrial_calibration/caljob_creator)
  set(caljob_creator_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  set(caljob_creator_INSTALL_PREFIX "")
  set(caljob_creator_PREFIX ${caljob_creator_DEVEL_PREFIX})
else()
  set(caljob_creator_SOURCE_PREFIX "")
  set(caljob_creator_DEVEL_PREFIX "")
  set(caljob_creator_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
  set(caljob_creator_PREFIX ${caljob_creator_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'caljob_creator' is deprecated")
...
set(caljob_creator_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(caljob_creator_INCLUDE_DIRS "")
  set(_include_dirs "/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  ...
  elseif(NOT "http://wiki.ros.org/caljob_creator " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/caljob_creator' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Chris Lewis <clewis@swri.org>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${caljob_creator_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'caljob_creator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'caljob_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/industrial_calibration/caljob_creator/${idir}'.  ${_report}")
    endif()
    _list_append_unique(caljob_creator_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND caljob_creator_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(caljob_creator_LIBRARY_DIRS ${lib_path})
      list(APPEND caljob_creator_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'caljob_creator'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND caljob_creator_LIBRARIES ${lib})
    endif()
  endif()
...
set(caljob_creator_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${caljob_creator_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cv_bridge;image_transport;roscpp;sensor_msgs;std_msgs;tf;industrial_extrinsic_cal")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 caljob_creator_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${caljob_creator_dep}_FOUND)
      find_package(${caljob_creator_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${caljob_creator_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(caljob_creator_INCLUDE_DIRS ${${caljob_creator_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(caljob_creator_LIBRARIES ${caljob_creator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${caljob_creator_dep}_LIBRARIES})
  _list_append_deduplicate(caljob_creator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(caljob_creator_LIBRARIES ${caljob_creator_LIBRARIES})

  _list_append_unique(caljob_creator_LIBRARY_DIRS ${${caljob_creator_dep}_LIBRARY_DIRS})
  list(APPEND caljob_creator_EXPORTED_TARGETS ${${caljob_creator_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${caljob_creator_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
