...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
...
if(NOT "/home/sinchiguano/yumi_depends_ws/devel/include;/home/sinchiguano/yumi_depends_ws/src/image_pipeline/image_proc/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/sinchiguano/yumi_depends_ws/devel/include;/home/sinchiguano/yumi_depends_ws/src/image_pipeline/image_proc/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/image_pipeline/image_proc/${idir}'.  ${_report}")
    endif()
