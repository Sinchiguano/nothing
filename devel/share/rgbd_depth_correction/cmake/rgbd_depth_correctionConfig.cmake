...
if("TRUE" STREQUAL "TRUE")
  set(rgbd_depth_correction_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/industrial_calibration/rgbd_depth_correction)
  set(rgbd_depth_correction_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  ...
  set(rgbd_depth_correction_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
...
if(NOT "/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(rgbd_depth_correction_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rgbd_depth_correction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/industrial_calibration/rgbd_depth_correction/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rgbd_depth_correction_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/libceres.so.1.12.0")
