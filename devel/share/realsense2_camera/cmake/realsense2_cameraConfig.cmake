...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/realsense-2.2.0/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
...
if(NOT "/home/sinchiguano/yumi_depends_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/realsense-2.2.0/realsense2_camera/${idir}'.  ${_report}")
    endif()
