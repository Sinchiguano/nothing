...
if("TRUE" STREQUAL "TRUE")
  set(industrial_extrinsic_cal_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/industrial_calibration/industrial_extrinsic_cal)
  set(industrial_extrinsic_cal_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  ...
  set(industrial_extrinsic_cal_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
...
if(NOT "/home/sinchiguano/yumi_depends_ws/devel/include;/home/sinchiguano/yumi_depends_ws/src/industrial_calibration/industrial_extrinsic_cal/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(industrial_extrinsic_cal_INCLUDE_DIRS "")
  set(_include_dirs "/home/sinchiguano/yumi_depends_ws/devel/include;/home/sinchiguano/yumi_depends_ws/src/industrial_calibration/industrial_extrinsic_cal/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/industrial_calibration/industrial_extrinsic_cal/${idir}'.  ${_report}")
    endif()
