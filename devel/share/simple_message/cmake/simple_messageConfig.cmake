...
if("TRUE" STREQUAL "TRUE")
  set(simple_message_SOURCE_PREFIX /home/sinchiguano/yumi_depends_ws/src/industrial_core/simple_message)
  set(simple_message_DEVEL_PREFIX /home/sinchiguano/yumi_depends_ws/devel)
  ...
  set(simple_message_INSTALL_PREFIX /home/sinchiguano/yumi_depends_ws/install)
...
if(NOT "/home/sinchiguano/yumi_depends_ws/src/industrial_core/simple_message/include " STREQUAL " ")
  set(simple_message_INCLUDE_DIRS "")
  set(_include_dirs "/home/sinchiguano/yumi_depends_ws/src/industrial_core/simple_message/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_message' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sinchiguano/yumi_depends_ws/src/industrial_core/simple_message/${idir}'.  ${_report}")
    endif()
...
set(pkg_cfg_extras "/home/sinchiguano/yumi_depends_ws/src/industrial_core/simple_message/cmake/issue46_workaround.cmake")
