...
class manual_triggerFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new manual_triggerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new manual_triggerFeedback(null);
...
module.exports = manual_triggerFeedback;
