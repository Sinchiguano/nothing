...
class manual_target_locationFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new manual_target_locationFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new manual_target_locationFeedback(null);
...
module.exports = manual_target_locationFeedback;
