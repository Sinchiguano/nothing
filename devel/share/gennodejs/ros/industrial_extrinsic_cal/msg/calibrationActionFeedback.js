...
let calibrationFeedback = require('./calibrationFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class calibrationActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new calibrationFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = calibrationFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new calibrationActionFeedback(null);
    ...
    data.feedback = calibrationFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new calibrationActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = calibrationFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new calibrationFeedback()
    }
...
module.exports = calibrationActionFeedback;
