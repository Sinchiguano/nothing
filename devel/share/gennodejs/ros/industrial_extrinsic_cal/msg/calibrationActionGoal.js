...
let calibrationGoal = require('./calibrationGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class calibrationActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = calibrationGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new calibrationActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = calibrationGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new calibrationGoal()
    }
...
module.exports = calibrationActionGoal;
