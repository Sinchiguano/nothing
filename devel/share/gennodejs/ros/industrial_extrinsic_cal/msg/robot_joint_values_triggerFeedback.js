...
class robot_joint_values_triggerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robot_joint_values_triggerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_joint_values_triggerFeedback(null);
...
module.exports = robot_joint_values_triggerFeedback;
