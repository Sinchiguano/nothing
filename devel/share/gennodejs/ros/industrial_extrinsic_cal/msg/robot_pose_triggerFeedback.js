...
class robot_pose_triggerFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robot_pose_triggerFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_pose_triggerFeedback(null);
...
module.exports = robot_pose_triggerFeedback;
